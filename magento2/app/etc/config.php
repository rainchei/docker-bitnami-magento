...
Disallow: /*SID=
            ...
            'general' => [
                ...
                'region' => [
                    'display_all' => '1',
                    'state_required' => 'AU,BR,CA,CH,CN,EE,ES,HR,IN,LT,LV,MX,RO,US',
                ],
            ],
            'theme' => [
                'customization' => [
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'connector_dynamic_content' => [
                'external_dynamic_content_urls' => [
                    'passcode' => '8DIvoeLIZiIWD4LKLOSIq0bHFbpYLhw3',
                ],
            ],
            ...
            'msp_securitysuite_twofactorauth' => [
                'duo' => [
                    'application_key' => 'oCh9K6jeBjU9v2AeW0EEj19Ea6tmjcy6ev4OHpCTFf9a2tMvOTpamdw4xQSCVjKp',
                ],
            ],
        ],
        'stores' => [
