...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'sales_channels' => [
                'sales_channel_integration' => [
                    'gateway_url' => 'https://api.magento.com/',
                    'service_path' => 'saleschannel',
                    'gateway_path' => 'gateway',
                    'frontend_url' => 'https://channels.magento.com',
                    'bypass_key_check' => '0',
                    'additional_headers' => '{}',
                    'enable_service_logs' => '0',
                ],
            ],
            'analytics' => [
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'jKeJV1RqFy5JtT3SRi12WSRCybclefxO',
            ...
            'msp_securitysuite_twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'XD2OkoLrwnQhIvRkcH3Kr4tmyRKWrXZr5FxwsLsTgbyae7haYtpsKEaU9TqV0Xjo',
                ],
            ],
            ...
            'yotpo' => [
                ...
                'sync_settings' => [
                    ...
                    'orders_sync_start_date' => '2020-02-27',
                ],
                'module_info' => [
                    'yotpo_installation_date' => '2020-02-27',
                ],
            ],
        ],
        'stores' => [
